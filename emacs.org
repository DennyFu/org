* Emacs todo lists
** TODO convert .emacs file to org
   http://mescal.imag.fr/membres/arnaud.legrand/misc/init.php
** TODO learn who to do if then else in org 
- e.g. for controlling latex typesetting
** DONE upgrade emacs
...
** DONE fix aspell	
   CLOSED: [2016-09-12 Mon 12:35]
   - State "DONE"       from "TODO"       [2016-09-12 Mon 12:35]
...
(custom-set-faces
 ...
 '(matlab-nested-function-keyword-face ((t (:overline t :slant italic))))
 '(matlab-region-face ((t (:background "aquamarine4")))))
(setq initial-frame-alist '((top . 1) (left . 1300) (width . 140) (height . 80)))
(setq default-frame-alist '((top . 1) (left . 1) (width . 140) (height . 80)))
(setq mac-option-key-is-meta nil)
(setq mac-command-key-is-meta t)
(setq mac-command-modifier 'meta)
(setq mac-option-modifier nil)
