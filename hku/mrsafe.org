...
Kinematic Model-free Positional Control for 
Robot-assisted Cardiac Catheterization 



This research presents model-free control interface capable of providing effective teleoperated control of a clinically used catheter, with the incorporation of visual-motor alignment.


This research presents a control interface that provides effective telemanipulation for Cardiac catheterization.
%
...
model-free approach
particle filtering
unknown and unstructured constrained environments

visual-motor alignment
motion consistent with approximated(virtual) visual feedback 



To provide an operator with a consistent motion reference

maneuver the catheter tip aiming at the desired target in unknown or unstructured constrained environments
visual-motor alignment.


subject tests
enhance navigation effectiveness



A sequential sampling method, particle filtering [1], is used to update the mapping from actuation input to our proposed virtual camera coordinate smoothly in order to realign the visual-motor coordinates time-by-time. It aims to provide the operator with a consistent motion reference to maneuver the catheter tip aiming at the desired target in unknown or unstructured constrained environments. Subject tests have been conducted to demonstrate how the proposed approach enhances the navigation effectiveness.
...
presents a model-free

References
[1] Ma et al., Journal of computer, vol.no, pp.xxx-xxx, 2012.
[2] Zheng et al., Circulation, vol.no, pp.xxx-xxx, 2001
