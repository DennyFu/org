...
- active tracking coils
  ...
  - structure
    - fig [wacker2004thecatheter]
    - small radiofrequency (RF) coils attached to the instrument, connected with a receiver system via coaxial cables [dumoulin1993realtime,duerk2002abriefreview]
    ...
    - Often, a single coil at the tip of the instrument is used for instrument tracking, which is then localized with a fast gradient echo acquisition of three orthogonal projections. 
...
- Three main heating mechanisms can occur: from eddy currents, induction loops, and resonating RF waves along a conducting device. The first two mechanisms do not involve storage of electrical energy. [marc2004visualization]
  ...
  - In the third mechanism, a resonant RF wave is reflected at the endpoints of the con- ducting structure, thus creating a standing wave and storage of electrical energy [ladd1998active,konings2000heating,nitz2001on](5,25,26). This is an important problem in conducting guide wires and active catheters. With a nitinol guide wire, temperatures of up to 74°C have been observed [konings2000heating].
