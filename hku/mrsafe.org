...
- What is MIS and its advantages
  ...
  - requires high precision of tool mainpulation within a relatively small, confined workspace
...
- What is MRI and its advantages in MIS
  - MRI provide better quality (intra-operative) images for monitoring the conditions of a patient during MIS procedure
  - surgeons do not need to expose to high magnetic field
...
- overview
  - 4 components in the close-loop: Image processing, sensory feedback, mri-compatible actuation, control interface
  - general setting in the MRI scanner room and the control room
    - fig

*** Image processing

- this component produces intra-operative MR images
...
- other common actuation methods 
  - ultrasound, piezoelectric
    - these two are commonly adopted in MR-compatible devices
    - pros and cons
...
- MR-compatible sensors
  - kinematics sensors
	...
	- connected with a wire (tethered)
      - working priciple
      - pros and cons 
